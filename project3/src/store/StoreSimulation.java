...
class StoreSimulation {
	...
	void simulateStore() {
		...
		for (int i = 1; i < dayNum + 1; i++) {
            ...
            System.out.println("-> All complete rentals:"); // A count and list of all completed rentals including which tools and options were rented by which customer, for how many days, along with the total fee for that rental
          ...
          //Add customers who came today but still have less than 3 tools back to customerList
            ...
            System.out.println("-> All active rentals:"); // A count and list of all active rentals, including which tools are rented by which customer
            ...
            System.out.println("-> Daily Income: "); // The amount of money the store made that day
